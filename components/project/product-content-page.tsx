    ...
    >
      ...
      <div className="mx-auto grid max-w-[1480px] gap-10 lg:min-h-[calc(92vh-10rem)] lg:grid-cols-[minmax(0,1.04fr)_minmax(320px,0.62fr)] lg:items-center">
        ...
        >
          ...
          >
            Premium cinematic product content created for brands, e-commerce
            stores and launch campaigns. Every edit is designed to increase
        ...
        >
          ...
          >
            <div className="relative aspect-[4/5] overflow-hidden rounded-sm bg-black">
              <Image
                src="/images/products/hero-thumb.svg"
...
function ProjectInfo() {
  const items = [
    ...
    {
      label: "Services",
      value: "Filming, Styling, Editing, Color Grading",
      icon: Layers3,
    },
...
function VideoCard({
  ...
  video: ProductVideo;
  isActive: boolean;
  onSelect: (video: ProductVideo | null) => void;
}) {
...
function VideoGallery() {
  const [selected, setSelected] = useState<ProductVideo | null>(null);
  ...
  const details = [
    {
      ...
      copy: "The visual direction leans into disciplined product staging, premium contrast and sharp brand recall. Each sequence is planned around the product's form and the story behind the launch.",
      icon: Target,
    },
    {
      title: "Camera And Lighting",
      copy: "Macro detail, locked-off hero frames and controlled practical lighting create a polished product presentation without losing the texture of the material.",
      icon: Film,
    },
    {
      title: "Post Workflow",
        ...
        <div data-reveal className="max-w-[1660px]">
          ...
          <p className="mt-7 max-w-[700px] text-base leading-7 text-white/60">
           A cinematic content system designed to position the brand as a premium
            product destination through strategic storytelling, disciplined
        ...
        <div className="mt-14 border-t border-white/10 pt-16">
          ...
          <article
            ...
            <p className="max-w-full text-[clamp(1.9rem,2.6vw,2.8rem)] font-black leading-[1.12] tracking-tight text-white">
              Build instant credibility, make every product feel aspirational,
            <br />
              and turn product content into a conversion asset across ads, reels,
