...
export const clothingVideos: ClothingVideo[] = [
  {
    id: 1,
    title: "Cinematic Apparel Promo",
    thumbnail: "/images/gym-content/thumb-01.svg",
    video: "https://kroo-production-assets-335667362073-ap-southeast-2.s3.ap-southeast-2.amazonaws.com/videos/clothing/1.mp4",
    description: "Commercial launch film for a premium apparel brand.",
    duration: "1:12",
    category: "Commercial",
  ...
  {
    id: 2,
    title: "Seasonal Drop Campaign",
    thumbnail: "/images/gym-content/thumb-02.svg",
    video: "https://kroo-production-assets-335667362073-ap-southeast-2.s3.ap-southeast-2.amazonaws.com/videos/clothing/2.mp4",
    description: "High-contrast lookbook sequence built for paid social.",
    duration: "0:48",
    category: "Campaign",
    client: "Fashion Industry",
  ...
  {
    id: 3,
    title: "Designer Brand Film",
    thumbnail: "/images/gym-content/thumb-03.svg",
    video: "https://kroo-production-assets-335667362073-ap-southeast-2.s3.ap-southeast-2.amazonaws.com/videos/clothing/3.mp4",
    description: "Personal brand story focused on craft and authority.",
    duration: "1:34",
    category: "Brand Film",
    client: "Fashion Industry",
  ...
  },
  {
    ...
    video: "https://kroo-production-assets-335667362073-ap-southeast-2.s3.ap-southeast-2.amazonaws.com/videos/clothing/4.mp4",
    description: "Premium showroom walkthrough with cinematic movement.",
    duration: "1:05",
    category: "Showcase",
    client: "Fashion Industry",
  ...
  {
    id: 5,
    title: "Lookbook Reels",
    thumbnail: "/images/gym-content/thumb-05.svg",
    video: "https://kroo-production-assets-335667362073-ap-southeast-2.s3.ap-southeast-2.amazonaws.com/videos/clothing/5.mp4",
  ...
  {
    id: 6,
    title: "Collection Launch Edit",
    thumbnail: "/images/gym-content/thumb-06.svg",
    video: "https://kroo-production-assets-335667362073-ap-southeast-2.s3.ap-southeast-2.amazonaws.com/videos/clothing/6.mp4",
    description: "Fast-cut collection launch film with aggressive rhythm.",
    duration: "0:42",
    category: "Launch",
    client: "Fashion Industry",
    services: ["Filming", "Editing", "Motion Graphics"],
  ...
  {
    id: 7,
    title: "Apparel Product Spot",
    thumbnail: "/images/gym-content/thumb-07.svg",
    video: "",
    description: "Product-focused fashion film for commercial placement.",
    duration: "0:56",
    category: "Product",
    client: "Fashion Industry",
  ...
  {
    id: 9,
    title: "Runway Montage",
    thumbnail: "/images/gym-content/thumb-09.svg",
    video: "",
    description: "Cinematic runway montage for organic brand growth.",
    duration: "1:21",
    category: "Montage",
    client: "Fashion Industry",
    services: ["Filming", "Editing", "Sound Design"],
    ...
    >
      ...
      <div className="mx-auto grid max-w-[1480px] gap-10 lg:min-h-[calc(92vh-10rem)] lg:grid-cols-[minmax(0,1.04fr)_minmax(320px,0.62fr)] lg:items-center">
        ...
        >
          ...
          >
            Premium fashion campaigns, apparel commercials, lifestyle
            storytelling and product films. Every edit is designed to
...
function VideoCard({
  ...
  video: ClothingVideo;
  onOpen: (video: ClothingVideo) => void;
}) {
  return (
    <button
      data-reveal
...
function VideoModal({
  ...
  videos: ClothingVideo[];
  selected: ClothingVideo | null;
  onClose: () => void;
  onSelect: (video: ClothingVideo) => void;
}) {
          ...
          <div className="grid gap-0 lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="mt-5 text-base leading-7 text-white/62">
                {selected.description} Built as part of a cinematic clothing
                content system for stronger engagement, premium perception and
                conversion-ready campaign delivery.
              </p>
...
function VideoGallery() {
  const [selected, setSelected] = useState<ClothingVideo | null>(null);

  return (
    <section id="work" className="relative scroll-mt-28 px-5 py-16 sm:px-8 lg:py-20">
      <SectionIntro
        eyebrow="Featured Videos"
        title="A curated collection of our cinematic clothing productions."
  ...
  const details = [
    {
      ...
      copy: "The visual direction leans into elevated styling, premium contrast and sharp brand recall. Each sequence is planned around the movement of the garment and the commercial message behind the campaign.",
      icon: Target,
    },
    {
      title: "Camera And Lighting",
      copy: "Dynamic gimbal movement, locked-off product frames and controlled practical lighting create a polished fashion environment without losing the texture of real fabric.",
      icon: Film,
    },
    {
      title: "Post Workflow",
        ...
        <div className="grid gap-5">
          ...
          >
            ...
            <p className="text-2xl font-bold leading-tight text-white sm:text-4xl">
              ...
              and turn clothing content into a conversion asset across ads,
...
export default function ClothingContentPage() {
  useLenis();
  useGsapReveal();
  useMagnetic();
