...
export default async function AiContentPage() {
  ...
  const config = {
    ...
    info: [
      ...
      { label: "Services", value: "Prompting, Generation, Editing, Motion Graphics", icon: Layers3 },
    ...
    about: {
      ...
      details: [
        { title: "Creative Direction", copy: "The visual direction leans into disciplined prompting, premium contrast and sharp brand recall. Each sequence is planned around the concept and the commercial message behind the campaign.", icon: Target },
        { title: "Camera And Lighting", copy: "Virtual camera movement, generated lighting and controlled scene composition create a polished AI production without losing believability.", icon: Film },
