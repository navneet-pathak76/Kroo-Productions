...
import type { DigitalMarketingVideo } from "../../lib/digital-marketing-videos";
    ...
    >
      ...
      <div className="mx-auto grid max-w-[1480px] gap-10 lg:min-h-[calc(92vh-10rem)] lg:grid-cols-[minmax(0,1.04fr)_minmax(320px,0.62fr)] lg:items-center">
        ...
        >
          ...
          >
            Premium performance-driven video content created for brands,
            agencies and marketing teams. Every edit is designed to increase
        ...
        >
          ...
          >
            <div className="relative aspect-[4/5] overflow-hidden rounded-sm bg-black">
              <Image
                src="/images/digital-marketing/hero-thumb.svg"
...
function ProjectInfo() {
  const items = [
    ...
    {
      label: "Services",
      value: "Strategy, Filming, Editing, Motion Graphics",
      icon: Layers3,
    },
...
function VideoCard({
  ...
  isActive: boolean;
  onSelect: (video: DigitalMarketingVideo | null) => void;
}) {
...
function VideoGallery() {
  const [selected, setSelected] = useState<DigitalMarketingVideo | null>(null);
  ...
  return (
    <section id="work" className="relative scroll-mt-28 px-2 py-16 sm:px-8 lg:py-20">
     <SectionIntro
      ...
      <br />
      CINEMATIC MARKETING PRODUCTIONS
      </>
      }
...
/>
      <div className="mx-auto grid max-w-[1480px] grid-cols-3 gap-3 sm:gap-4 lg:grid-cols-4 lg:gap-5">
        {digitalMarketingVideos.map((video) => (
          <VideoCard
            key={video.id}
            video={video}
  ...
  const details = [
    {
      ...
      copy: "The visual direction leans into disciplined hooks, premium contrast and sharp brand recall. Each sequence is planned around the funnel stage and the commercial message behind the campaign.",
      icon: Target,
    },
    {
      title: "Camera And Lighting",
      copy: "Dynamic handheld movement, locked-off product frames and controlled practical lighting create a polished marketing asset built for scroll-stopping attention.",
      icon: Film,
    },
    {
      title: "Post Workflow",
        ...
        <div data-reveal className="max-w-[1660px]">
          ...
          <p className="mt-7 max-w-[700px] text-base leading-7 text-white/60">
           A cinematic content system designed to position the brand as a premium
            marketing destination through strategic storytelling, disciplined
        ...
        <div className="mt-14 border-t border-white/10 pt-16">
          ...
          <article
            ...
            <p className="max-w-full text-[clamp(1.9rem,2.6vw,2.8rem)] font-black leading-[1.12] tracking-tight text-white">
              Build instant credibility, make every campaign feel aspirational,
            <br />
              and turn marketing content into a conversion asset across ads, reels,
