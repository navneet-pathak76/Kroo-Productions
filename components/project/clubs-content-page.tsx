...
export const clubsVideos: ClubsVideo[] = [
  {
    id: 1,
    title: "Cinematic Club Promo",
    thumbnail: "/images/gym-content/thumb-01.svg",
    video: "https://d3uo687t366hok.cloudfront.net/videos/clubs/1.mp4",
    description: "Commercial launch film for a premium nightlife venue.",
    duration: "1:12",
    category: "Commercial",
  ...
  {
    id: 2,
    title: "DJ Night Campaign",
    thumbnail: "/images/gym-content/thumb-02.svg",
    video: "https://d3uo687t366hok.cloudfront.net/videos/clubs/2.mp4",
    description: "High-contrast event sequence built for paid social.",
    duration: "0:48",
    category: "Campaign",
    client: "Nightlife Industry",
  ...
  {
    id: 6,
    title: "Event Launch Edit",
    thumbnail: "/images/gym-content/thumb-06.svg",
    video: "",
    description: "Fast-cut event launch film with aggressive rhythm.",
    duration: "0:42",
    category: "Launch",
    client: "Nightlife Industry",
    services: ["Filming", "Editing", "Motion Graphics"],
  ...
  {
    id: 7,
    title: "Concert Highlight Spot",
    thumbnail: "/images/gym-content/thumb-07.svg",
    video: "",
    description: "Performance-focused concert film for commercial placement.",
    duration: "0:56",
    category: "Product",
    client: "Nightlife Industry",
  ...
  {
    id: 9,
    title: "Crowd Energy Montage",
    thumbnail: "/images/gym-content/thumb-09.svg",
    video: "",
    description: "Cinematic crowd montage for organic brand growth.",
    duration: "1:21",
    category: "Montage",
    client: "Nightlife Industry",
    services: ["Filming", "Editing", "Sound Design"],
    ...
    >
      ...
      <div className="mx-auto grid max-w-[1480px] gap-10 lg:min-h-[calc(92vh-10rem)] lg:grid-cols-[minmax(0,1.04fr)_minmax(320px,0.62fr)] lg:items-center">
        ...
        >
          ...
          >
            Nightlife promotions, DJ events, concerts, cinematic club films
            and aftermovies. Every edit is designed to increase engagement,
            brand value and conversions.
          </motion.p>
          <motion.div
            variants={fadeUp}
            custom={3}
...
function VideoModal({
  ...
  videos: ClubsVideo[];
  selected: ClubsVideo | null;
  onClose: () => void;
  onSelect: (video: ClubsVideo) => void;
}) {
          ...
          <div className="grid gap-0 lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="mt-5 text-base leading-7 text-white/62">
                {selected.description} Built as part of a cinematic club
...
function VideoGallery() {
  const [selected, setSelected] = useState<ClubsVideo | null>(null);

  return (
    <section id="work" className="relative scroll-mt-28 px-5 py-16 sm:px-8 lg:py-20">
      <SectionIntro
        eyebrow="Featured Videos"
        title="A curated collection of our cinematic club productions."
        ...
        <div className="grid gap-5">
          ...
          >
            ...
            <p className="text-2xl font-bold leading-tight text-white sm:text-4xl">
              Build instant credibility, make the venue feel aspirational,
              and turn club content into a conversion asset across ads,
